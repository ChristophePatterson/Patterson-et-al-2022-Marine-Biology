...
#Creating filenames
cf.folder <- "C:/Users/cwp206/Ocean-models/ichthyop_3.3.3/ichthyop_3.3.3/cfg/Vertical_migration/All_cfg/"
...
sunsettimes$simulation.start.time <- paste("year", sunsettimes$year, 
                                           ...
                                           "day", sunsettimes$day, 
                                           "at", sunsettimes$time)
#Creating a output file location
default.output <- "/mnt/c/Users/cwp206/Ocean-models/ichthyop_3.3.3/ichthyop_3.3.3/output/Vertical migration/"
...
#Reading in Outline of file
text.file <- readLines("C:/Users/cwp206/Ocean-models/ichthyop_3.3.3/ichthyop_3.3.3/cfg/Vertical_migration/Outline_for_single_VM_config_file.xml")
